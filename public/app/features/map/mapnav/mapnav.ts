...
export function mapNavDirective() {
  return {
    restrict: 'E',
    templateUrl: 'public/app/features/map/mapnav/mapnav.html',
    controller: MapNavCtrl,
    transclude: true,
  };
}

angular.module('grafana.directives').directive('mapnav', mapNavDirective);
